    ...
    <div className="hidden lg:flex flex-col ml-7 mt-4">
      ...
      <div className="w-[300px] h-[500px] bg-white bg-opacity-10 rounded-3xl mt-3">
        ...
        <div className="p-3 relative">
          ...
          <h1 className="text-[15px] font-bold">Christians Bitch Ass</h1>
          <p className="text-xs text-gray-500">1 Tweet</p>
        </div>
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending</p>
          <h1 className="text-[15px] font-bold">Seth Websters Birthday</h1>
          <p className="text-xs text-gray-500">52K Tweets</p>
        </div>
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending</p>
          <h1 className="text-[15px] font-bold">Lee Is A Bitch</h1>
